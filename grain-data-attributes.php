...
define ( 'GRAIN_DATA_ATTRIBUTES_PAGE_VARIABLES_CONFIG',  array(
		"pageTitle",
		"pagePublishDate",
		"pageCategories",
		"pageTags",
...
function bootstrap__jquery_scripts() {
    ...
    wp_enqueue_script( 'grain_data_attributes_jquery_js', GRAIN_DATA_ATTRIBUTES_URL . '/admin/assets/vendors/jquery/jquery.min.js', false);
}
add_action( 'admin_enqueue_scripts', 'bootstrap__jquery_scripts' );
